...
@section('page_js')
    <script>
        ...
        function restoreAccount(id) {
            ...
            $.ajax({
                url: '/user/restore/' + id, // Thay đổi đúng route của bạn
                type: 'GET',
                dataType: 'json',
                    ...
                    if (response.success) {
                        ...
                        Swal.fire({
                            ...
                            .then(() => {
                                ...
                                window.location.href = '/user/trash'; // Thay đổi đúng route của bạn
                            });
                    } else {
                        ...
                        Swal.fire({
                            icon: 'error',
                            title: 'Oops...',
                            text: 'Đã xảy ra lỗi khi khôi phục tài khoản!'
                        });
                    }
                },
    ...
    <script type="text/javascript">
        ...
        let removeItem = function(id) {
            $.confirm({
                theme: theme,
                title: 'Xác nhận',
                content: 'Bạn có muốn xóa vĩnh viễn tài khoản?',
