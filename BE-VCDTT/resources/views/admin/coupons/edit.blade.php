                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" name="type" id="">
                                <option {{ $response->percentage_price!=null?'selected':'' }} value="1">Percentage</option>
                                <option {{ $response->percentage_price==null?$response->fixed_price!=null?'selected':'':'' }} value="2">Fixed</option>
                            </select>
                            <br>
