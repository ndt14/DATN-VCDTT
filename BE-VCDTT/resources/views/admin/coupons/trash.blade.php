                ...
                <div class="col-12">
                    <div class="card border-0 shadow-lg rounded-4 ">
                        <div class="card-header">
                            <h3 class="card-title">Mã giảm giá</h3> <a href="{{ route('coupon.trash') }}"
...
@section('page_js')
    <script>
        ...
        function restoreCoupon(id) {
            ...
            $.ajax({
                url: '/coupon/restore/' + id, // Thay đổi đúng route của bạn
                type: 'GET',
                dataType: 'json',
                    ...
                    if (response.success) {
                        ...
                        Swal.fire({
                            ...
                            .then(() => {
                                ...
                                window.location.href = '/coupon/trash'; // Thay đổi đúng route của bạn
                            });
                    } else {
                        ...
                        Swal.fire({
                            icon: 'error',
                            title: 'Oops...',
                            text: 'Đã xảy ra lỗi khi khôi phục mã giảm giá!'
                        });
                    }
                },
