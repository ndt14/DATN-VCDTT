                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="javascript: viewDetail({{ $item->id }});"
                                                        title="Show Detail">{{ string_truncate($item->question, 70) }}</a>
                                                </td>
                                                <td>
...
@section('page_js')
    <script>
        ...
        function restoreFaq(id) {
            ...
            $.ajax({
                url: '/faq/restore/' + id, // Thay đổi đúng route của bạn
                type: 'GET',
                dataType: 'json',
                success: function(response) {
                    ...
                    if (response.success) {
                        ...
                        Swal.fire({
                                title: 'Thành công!',
                                text: 'Khôi phục faq thành công',
                                icon: 'success'
                            })
                            .then(() => {
                                // Chuyển hướng sau khi hiển thị modal
                                window.location.href = '/faq/trash'; // Thay đổi đúng route của bạn
                            });
                    } else {
                        ...
                        Swal.fire({
                            icon: 'error',
                            title: 'Oops...',
                            text: 'Đã xảy ra lỗi khi khôi phục faq!'
                        });
                    }
                },
