                    ...
                    <div class="card border-0 shadow-lg rounded-4 ">
                        <div class="card-header">
                            <h3 class="card-title">Ảnh</h3> <a href=""
                                style="padding-left: 5px; text-decoration: none;"><span style="color: black;">|</span> Thùng
                                rác</a>
                        </div>
                                    ...
                                    @if ($data)
                                        @foreach ($data as $item)
                                            <tr>
                                                ...
                                                <td class="text-end">
                                                    <a href="javascript: void(0);" data-url="{{ url($item->url) }}"
        ...
        $(document).ready(function() {
            ...
            $('.btn-copy-url').click(function() {
                ...
                clipboard.writeText(url).then(function() {
                    ...
                    Swal.fire({
                            title: 'Thành công!',
                            text: 'Đã copy đường dẫn thành công',
                            icon: 'success'
                        })
                        .then((response) => {
                            if (response) {
