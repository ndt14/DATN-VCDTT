                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <select name="purchase_status" class="form-select" aria-label="Default select example">
                                    ...
                                    <option @if ($items['purchase_status'] == 6) selected @endif value="8">Admin đã hủy tour
                                    </option>
                                    <option @if ($items['purchase_status'] == 8) selected @endif value="9">Tự động đơn đặt hủy do quá hạn thanh toán
                                    </option>
                                    <option @if ($items['purchase_status'] == 9) selected @endif value="10">Đã hoàn tiền
                                    </option>
                                    <option @if ($items['purchase_status'] == 10) selected @endif value="11">Người dùng đã đánh giá
                                    </option>
