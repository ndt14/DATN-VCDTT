...
@section('content')
    ...
    @endif
                ...
                {{-- <div class="col-auto ms-auto d-print-none">
                    <div class="btn-list">
                        <a href="{{ route('') }}" class="btn btn-indigo d-none d-sm-inline-block">
                ...
                <div class="col-12">
                    <div class="card border-0 shadow-lg rounded-4 ">
                        <div class="card-header">
                            <h3 class="card-title">Hóa đơn</h3> <a href="" style="padding-left: 5px; text-decoration: none;"><span style="color: black;">|</span> Thùng rác</a>
                        </div>
