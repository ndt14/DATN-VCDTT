                ...
                <div class="row">
                    <div class="mb-3 col-9">
                        ...
                        <input type="text" name="name" class="form-control"
                            placeholder="Nhập tên người dùng" value="{{ $item['name'] }}" disabled>
                    ...
                    <div class="mb-3 col-3">
                        ...
                        <input type="text" name="user_id" class="form-control"
                            placeholder="Nhập ID người dùng" value="{{ $item['user_id'] }}" disabled>
                        <span class="text-danger d-flex justify-content-start">
                            @error('user_id')
                                {{ $message }}
                            @enderror
                ...
                <div class="row">
                    <div class="mb-3 col-4">
                        ...
                        <input type="email" name="main_img" class="form-control"
                            placeholder="Email người đặt tour" value="{{ $item['email'] }}" disabled>
                        <span class="text-danger d-flex justify-content-start">
                            @error('email')
                                {{ $message }}
                            @enderror
                ...
                <div class="row">
                    <div class="mb-3 col-6">
                        ...
                        <input name="tour_name" type="text" placeholder="Nhập tên tour"
                            class="form-control" value="{{ $item['tour_name'] }}" disabled>
                        <span class="text-danger d-flex justify-content-start">
                            @error('tour_name')
                                {{ $message }}
                            @enderror
                    ...
                    <div class="mb-3 col-6">
                        ...
                        <input name="tour_duration" type="text" placeholder="Nhập độ dài tour"
                            class="form-control" value="{{ $item['tour_duration'] }}" disabled>
                        <span class="text-danger d-flex justify-content-start">
                            @error('tour_duration')
                                {{ $message }}
                            @enderror
                ...
                <div class="row">
                    <div class="mb-3 col-3">
                        ...
                        <input name="child_count" type="text" placeholder="Nhập số trẻ em"
                            class="form-control" value="{{ $item['child_count'] }}" disabled>
                        <span class="text-danger d-flex justify-content-start">
                            @error('child_count')
                                {{ $message }}
                            @enderror
                    ...
                    <div class="mb-3 col-3">
                        ...
                        <input name="adult_count" type="text" placeholder="Nhập số người lớn"
                            class="form-control" value="{{ $item['adult_count'] }}" disabled>
                        <span class="text-danger d-flex justify-content-start">
                            @error('adult_count')
                                {{ $message }}
                            @enderror
                ...
                <div class="row">
                    <div class="mb-3 col-6">
                        ...
                        <input name="tour_start_destination" type="text"
                            ...
                            value="{{ $item['tour_start_destination'] }}" disabled>
                        <span class="text-danger d-flex justify-content-start">
                    ...
                    <div class="mb-3 col-6">
                        ...
                        <input name="tour_end_destination" type="text"
                            ...
                            value="{{ $item['tour_end_destination'] }}" disabled>
                        <span class="text-danger d-flex justify-content-start">
                ...
                <div class="row">
                    <div class="mb-3 ">
                        ...
                        <input name="tour_location" type="text" class="form-control"
                            placeholder="Nhập vị trí của tour" value="{{ $item['tour_location'] }}"
                            disabled>
                        <span class="text-danger d-flex justify-content-start">
                            @error('tour_location')
                                {{ $message }}
                ...
                <div class="row">
                    <div class="mb-3 col-3">
                        ...
                        <input name="tour_sale_percentage" type="text" class="form-control"
                            ...
                            value="{{ $item['tour_sale_percentage'] }}" disabled>
                        <span class="text-danger d-flex justify-content-start">
                    ...
                    <div class="mb-3 col-3">
                        ...
                        <input name="coupon_fixed" type="text" class="form-control"
                            placeholder="Nhập phần trăm giảm giá của mã giảm giá"
                            value="{{ $item['coupon_fixed'] }}" disabled>
                        <span class="text-danger d-flex justify-content-start">
                            @error('coupon_fixed')
                                {{ $message }}
                            @enderror
                ...
                <div class="row">
                    <div class="mb-3 ">
                        ...
                        <input name="refund_percentage" type="text" class="form-control"
                            placeholder="Nhập vị trí của tour" value="{{ $item['refund_percentage'] }}"
                            disabled>
                        <span class="text-danger d-flex justify-content-start">
                    ...
                    <div class="custom-controls-stacked">
                        <label class="custom-control custom-radio custom-control-inline me-2">
                            <input type="radio" class="custom-control-input" disabled
                                @if ($item['payment_status'] == '1') checked @endif name="payment_status"
                                value="1">
                            <span class="custom-control-label">Đã thanh toán</span>
                        </label>
                        <label class="custom-control custom-radio custom-control-inline">
                            <input type="radio" class="custom-control-input" disabled
                                @if ($item['payment_status'] == '0') checked @endif name="payment_status"
                                value="0">
