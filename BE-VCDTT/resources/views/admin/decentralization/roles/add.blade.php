                                                ...
                                                <tbody>
                                                    <tr style="border-bottom: 1px solid #0D6EFD;">
                                                        ...
                                                        <td><input name="permission[]" data-bs-toggle="tooltip"
                                                                ...
                                                                aria-label="Select all invoices" value="4"></td>
                                                        <td><input name="permission[]" data-bs-toggle="tooltip"
                                                                title="Quyền thêm mới tour"
                                                                class="form-check-input m-0 align-middle" type="checkbox"
                                                                aria-label="Select all invoices" value="1"></td>
                                                        <td><input name="permission[]" data-bs-toggle="tooltip"
                                                                title="Quyền sửa tour"
                                                                class="form-check-input m-0 align-middle" type="checkbox"
                                                                aria-label="Select all invoices" value="2"></td>
                                                        <td><input name="permission[]" data-bs-toggle="tooltip"
                                                                title="Quyền xóa tour"
                                                                class="form-check-input m-0 align-middle" type="checkbox"
                                                                aria-label="Select all invoices" value="3"></td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr style="border-bottom: 1px solid #0D6EFD;">
                                                        ...
                                                        <td><input name="permission[]"
                                                                ...
                                                                aria-label="Select all invoices" value="27"></td>
                                                        <td><input name="permission[]"
                                                                class="form-check-input m-0 align-middle"
                                                    ...
                                                    <tr style="border-bottom: 1px solid #0D6EFD;">
                                                        ...
                                                        <td><input name="permission[]" data-bs-toggle="tooltip"
                                                                ...
                                                                class="form-check-input m-0 align-middle" type="checkbox"
                                                                aria-label="Select all invoices" value="23"></td>
                                                        <td><input name="permission[]" data-bs-toggle="tooltip"
                                                                title="Quyền thêm mới faq"
                                                                class="form-check-input m-0 align-middle" type="checkbox"
                                                                aria-label="Select all invoices" value="20"></td>
                                                        <td><input name="permission[]"
                                                                class="form-check-input m-0 align-middle"
                                                        ...
                                                        <td><input name="permission[]"
                                                                ...
                                                                aria-label="Select all invoices" value="22"></td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr style="border-bottom: 1px solid #0D6EFD;">
                                                        ...
                                                        <td><input name="permission[]"
                                                                ...
                                                                aria-label="Select all invoices" value="11"></td>
                                                        <td><input name="permission[]"
                                                                class="form-check-input m-0 align-middle"
                                                        ...
                                                        <td><input name="permission[]"
                                                                ...
                                                                aria-label="Select all invoices" value="9"></td>
                                                        <td><input name="permission[]"
                                                                class="form-check-input m-0 align-middle" type="checkbox"
                                                                data-bs-toggle="tooltip" title="Quyền xóa danh mục"
                                                                aria-label="Select all invoices" value="10"></td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr style="border-bottom: 1px solid #0D6EFD;">
                                                        ...
                                                        <td colspan="2"><input name="permission[]"
                                                                ...
                                                                aria-label="Select all invoices" value="7"></td>
                                                        <td><input name="permission[]"
                                                                class="form-check-input m-0 align-middle" type="checkbox"
                                                                data-bs-toggle="tooltip" title="Quyền sửa hóa đơn"
                                                                aria-label="Select all invoices" value="5"></td>
                                                        <td><input name="permission[]"
                                                                class="form-check-input m-0 align-middle" type="checkbox"
                                                                data-bs-toggle="tooltip" title="Quyền xóa hóa đơn"
                                                                aria-label="Select all invoices" value="6"></td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr style="border-bottom: 1px solid #0D6EFD;">
                                                        ...
                                                        <td><input name="permission[]"
                                                                ...
                                                                aria-label="Select all invoices" value="15"></td>
                                                        <td><input name="permission[]"
                                                                class="form-check-input m-0 align-middle"
                                                        ...
                                                        <td><input name="permission[]"
                                                                ...
                                                                aria-label="Select all invoices" value="13"></td>
                                                        <td><input name="permission[]"
                                                                class="form-check-input m-0 align-middle" type="checkbox"
                                                                data-bs-toggle="tooltip" title="Quyền xóa mã giảm giá"
                                                                aria-label="Select all invoices" value="14"></td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr style="border-bottom: 1px solid #0D6EFD;">
                                                        ...
                                                        <td><input name="permission[]"
                                                                ...
                                                                aria-label="Select all invoices" value="19"></td>
                                                        <td><input name="permission[]"
                                                                class="form-check-input m-0 align-middle"
                                                        ...
                                                        <td><input name="permission[]"
                                                                ...
                                                                aria-label="Select all invoices" value="17"></td>
                                                        <td><input name="permission[]"
                                                                class="form-check-input m-0 align-middle" type="checkbox"
                                                                data-bs-toggle="tooltip" title="Quyền xóa tài khoản"
                                                                aria-label="Select all invoices" value="18"></td>
                                                    </tr>
                                                    <tr>
