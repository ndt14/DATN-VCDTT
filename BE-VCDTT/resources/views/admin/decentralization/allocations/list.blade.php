                                                ...
                                                <td class="text-end">
                                                    @if (!($role->name == 'Admin'))
                                                        <a class="btn btn-icon btn-outline-green"
                                                            href="{{ route('allocation.edit', ['user_id' => $item->id]) }}">
    ...
    <script type="text/javascript">
        ...
        let removeItem = function(id) {
            $.confirm({
                theme: theme,
                title: 'Xác nhận',
                content: 'Bạn có chắc muốn xóa đi tất cả quyền của tài khoản này?',
    ...
    <script>
        ...
        nameRoles.forEach(item => {
            item.addEventListener("click", () => {
                ...
                Swal.fire({
                    title: "Xác nhận?",
                    text: "Bạn muốn xóa đi quyền này của người dùng",
                    icon: "warning",
