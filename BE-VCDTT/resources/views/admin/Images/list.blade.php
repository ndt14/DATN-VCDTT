        ...
        <div class="container-xl">
            <div class="row g-2 align-items-center">
                ...
                <!-- <div class="col-auto ms-auto d-print-none">
                    <div class="btn-list">
                        <a href="{{ route('image.add') }}" class="btn btn-primary d-none d-sm-inline-block">
                        ...
                        <a href="{{ route('image.add') }}" class="btn btn-primary d-sm-none btn-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24"
                                viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none"
                                stroke-linecap="round" stroke-linejoin="round">
                                <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                                        ...
                                        @foreach ($data as $item)
                                            ...
                                            <td>
                                                ...
                                                <td class="text-end">
                                                    ...
                                                    <a class="btn btn-icon btn-outline-primary" href="/image-download/{{ $item->id}}" title="Tải xuống">
