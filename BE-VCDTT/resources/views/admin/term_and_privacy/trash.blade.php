...
@section('page_js')
    <script>
        ...
        function restorePage(id) {
            ...
            $.ajax({
                url: '/page/restore/' + id, // Thay đổi đúng route của bạn
                type: 'GET',
                dataType: 'json',
                success: function(response) {
                    if (response.success) {
                        ...
                        Swal.fire({
                                title: 'Thành công!',
                                text: 'Khôi phục điều khoản & dịch vụ thành công',
                                icon: 'success'
                            })
                            .then(() => {
                                // Chuyển hướng sau khi hiển thị modal
                                window.location.href = '/page/trash'; // Thay đổi đúng route của bạn
                            });
                    } else {
                        ...
                        Swal.fire({
                            icon: 'error',
                            title: 'Oops...',
                            text: 'Đã xảy ra lỗi khi khôi phục điều khoản & dịch vụ!'
                        });
                    }
                },
    ...
    <script type="text/javascript">
        ...
        let removeItem = function(id) {
            $.confirm({
                theme: theme,
                title: 'Xác nhận',
                content: 'Xóa vĩnh viễn điều khoản & dịch vụ này?',
                    ...
                    removeButton: {
                        ...
                        action: function() {
                            axios.delete(`/api/page-destroy-forever/${id}`).then(function(response) {
                                Swal.fire({
                                        title: 'Thành công!',
                                        text: 'Xóa điều khoản & dịch vụ thành công',
                                        icon: 'success'
                                    })
                                    .then((response) => {
                                        if (response) {
