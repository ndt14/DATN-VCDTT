                ...
                <div class="col-12">
                    <div class="card border-0 shadow-lg rounded-4 ">
                        <div class="card-header">
                            ...
                            @if(auth()->user()->is_admin == 1 || auth()->user()->can('delete page'))
                            <a href="{{route('page.trash')}}" style="padding-left: 5px; text-decoration: none; color: black; font-weight: 700;"><span style="color: black;">|</span> Thùng rác</a>
                            @endif
                        </div>
                                        ...
                                        @foreach ($data as $item)
                                            ...
                                            <td><span class="text-muted">{{ $item->id }}</span></td>
                                                ...
                                                <td class="text-end">
                                                    ...
                                                    <a class="btn btn-icon btn-outline-green" href="{{route('page.restore', ['id'=>$item->id])}}">
        ...
        $.confirm({
            ...
            buttons: {
                removeButton: {
                    ...
                    btnClass: 'btn-danger',
                    action: function() {
                        axios.delete(`/api/page-destroy-forever/${id}`).then(function(response) {
                            Swal.fire({
                            position: "top-center",
                            icon: "success",
