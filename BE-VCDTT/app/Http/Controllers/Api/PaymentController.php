...
class PaymentController extends Controller
{
    public function vnpayPayment(Request $request)
    {
        ...
        $finalPrice = $finalPrice - ($purchaseHistory->coupon_percentage == null ? ($purchaseHistory->coupon_fixed ?? 0) : 0) - ($finalPrice / 100 * ($purchaseHistory->coupon_percentage ?? 0 + $purchaseHistory->tour_sale_percentage ?? 0));
        // dd($finalPrice);
