            ...
            <div className="row">
              <div className="col-lg-3 col-md-6">
                <aside className="widget widget_text">
                  ...
                  <div className="textwidget widget-text">
                    - VCDTT là một trang web bán tour du lịch đầy màu sắc và
                    phong phú. <br />
                    - Chúng tôi cung cấp những trải nghiệm du lịch tuyệt vời với
                    các tour độc đáo, dẫn đường chuyên nghiệp và dịch vụ chăm
                    sóc khách hàng tận tâm. <br />- Hãy ghé thăm VCDTT để khám
                    phá những điểm đến hấp dẫn và tạo ra những kỷ niệm đáng nhớ!
                  </div>
              ...
              <div className="col-lg-3 col-md-6">
                <aside className="widget widget_text">
                  ...
                  <div className="textwidget widget-text">
                    Nếu có thắc mắc hãy liên hẹ với chúng tôi qua các phương
                    thức liên lạc
                    <ul>
                      <li>
                        <a href="#">
                          <i className="fas fa-phone-alt"></i>
                          {dataPhone?.data.keyvalue.map(
                            ({ id, value }: Setting) => {
